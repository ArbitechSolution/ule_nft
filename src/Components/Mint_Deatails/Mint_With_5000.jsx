...
export default function Mint_With_5000() {
  ...
  const handleValueChange = async () => {
    ...
    mintingULEPrice = value * mintingULEPrice?.data?.data[0]?.usdperunit * 2500;
      ...
      try {
        try {
          ...
          if (value > totalnft) {
            ...
            mintingULEPrice =
              value * mintingULEPrice?.data?.data[0]?.usdperunit * 2500;
            ...
            mintingBNBPrice =
              value * mintingBNBPrice?.data?.data[0]?.usdperunit * 2500;
