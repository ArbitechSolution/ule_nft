...
export default function Mint_With_10000() {
  ...
  const handleValueChange = async () => {
    ...
    mintingULEPrice = value * mintingULEPrice?.data?.data[0]?.usdperunit * 5000;
      ...
      try {
        try {
          ...
          if (value > totalnft) {
            ...
            mintingULEPrice =
              value * mintingULEPrice?.data?.data[0]?.usdperunit * 5000;
            ...
            mintingBNBPrice =
              value * mintingBNBPrice?.data?.data[0]?.usdperunit * 5000;
