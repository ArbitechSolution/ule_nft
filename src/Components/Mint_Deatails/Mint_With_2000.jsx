...
export default function Mint_With_2000() {
  ...
  const handleValueChange = async () => {
    ...
    mintingULEPrice = value * mintingULEPrice?.data?.data[0]?.usdperunit * 1000;
      ...
      try {
        try {
          ...
          if (value > totalnft) {
            ...
            mintingULEPrice =
              value * mintingULEPrice?.data?.data[0]?.usdperunit * 1000;
            ...
            mintingBNBPrice =
              value * mintingBNBPrice?.data?.data[0]?.usdperunit * 1000;
