        ...
        if (res == 1) {
          try {
            ...
            if (value > totalnft) {
              ...
              totalMintingPriceBNB = web3.utils.toWei(
                totalMintingPriceBNB.toString()
              );
                ...
                if (parseInt(ttlSupply) < parseInt(maxSupply)) {
                  if (paused == false) {
                    if (value < parseInt(maxLimitprTransaction)) {
                      ...
                      let BusdPrice = await nftContractOf.methods
                        .WhitelistMinitngPricein_BUSD()
                        .call();
                      ...
                      await busdContractOf.methods
                        .approve(wireNftContractAddress, b)
                        .send({
                          from: acc,
                        });
                      ...
                      toast.success("Transaction Confirmed");
                      let hash = await nftContractOf.methods
                        .mint_with_BUSD(value, b.toString())
                        .send({
                          from: acc,
                        });
                      toast.success("Transaction Confirmed");
